...
from utils.workspace_services import send_request_workspace_reload_data
...
class ColumnsListView(APIView):
    ...
    def post(self, request, workspace_id):
        ...
        if serializer.is_valid():
            ...
            # send request socket reload data to all users in workspace
            send_request_workspace_reload_data(request.user.id, workspace_id)
...
class MoveColumnView(APIView):
    ...
    def post(self, request, workspace_id):
        ...
        workspace = Workspaces.objects.get(id=workspace_id)
        workspace.column_orders = column_orders
        workspace.save()
